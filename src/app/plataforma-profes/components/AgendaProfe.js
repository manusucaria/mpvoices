...
const AgendaProfe = ({ availableDays, profesor }) => {
  ...
  return (
    <div id='Agenda' className="flex flex-col w-full">
        ...
        {selectedDay
          ...
          {selectedDay && (
            <div className="flex flex-col overflow-x-auto mx-auto w-full px-2 md:w-4/6 mb-12">
              <div className='grid grid-cols-[20%_80%] grid-rows-37 border-[0.5px] sm:border-1 border-[#0D0D0D]'>
                <div className="border-b-[0.5px] sm:border-b-1 border-b-[#0D0D0D] border-r-[0.5px] sm:border-r-1 border-r-[#0D0D0D] bg-[#E9500E] h-9 sm:h-12 text-center col-start-1 col-end-2 row-start-1 row-end-2 flex">
                  <p className='text-md sm:text-md md:text-base m-auto text-[#FFFFFF]'>Horario</p>
                </div>
                {timeSlots.map((time, index) => (
                  <div
                    key={index}
                    className={`text-center border-r-[0.5px] sm:border-r-1 border-r-[#0D0D0D] col-start-1 col-end-2 bg-[#FFFFFF] flex h-9 sm:h-12 ${index === timeSlots.length - 1 ? 'border-b-none' : 'border-b-[0.5px] sm:border-b-1 border-b-[#0D0D0D]'}`}
                  >
                ...
                <div className="col-start-2 col-end-3 row-start-1 row-end-38 grid grid-cols-1 bg-[#FFFFFF]">
                  <div className="grid grid-cols-1 grid-rows-37 text-center">
                    <div className='border-b-[0.5px] sm:border-b-1 border-b-[#0D0D0D] flex row-start-1 row-end-2 h-9 sm:h-12 text-sm bg-[#E9500E]'>
