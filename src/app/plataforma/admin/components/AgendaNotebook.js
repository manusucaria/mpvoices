                      ...
                      .map((alumno) => (
                        ...
                        >
                            ...
                            <div className='row-start-2 row-end-5 col-start-1 col-end-6'>
                              <p className="text-[0.80rem] min-[810px]:text-[0.8rem] min-[950px]:text-[0.9rem] font-bold text-black">
                                Alumno: {alumno.usuario.full_name.nombre}{' '}
                                {alumno.usuario.full_name.apellido}
                              </p>
                              <p className="text-[0.80rem] min-[810px]:text-[0.8rem] min-[950px]:text-[0.9rem] text-black">
