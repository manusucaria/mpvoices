        ...
        <div className="flex flex-col mt-auto ">
            ...
            <div className="flex flex-col w-full mx-auto mb-6 border-b pb-4 border-b-[#ffffff]">
                <div className="mb-2 mx-auto flex">
                    <p className="mx-auto font-semibold">E-Mail:&nbsp;</p>
                    <a className="mx-auto" href="mailto:info@mpvoices.com.ar" target="_blank">{email}</a>
                </div>
                <div className="mb-2 mx-auto flex">
                    <p className="mx-auto font-semibold">Teléfono:&nbsp;</p>
                    <a className="mx-auto" href="https://wa.me/15551234567" target="_blank">{tel}</a>
                </div>
                <div className="mb-2 mx-auto flex">
                    <p className="mx-auto font-semibold">Dirección:&nbsp;</p>
                    <a className="mx-auto" href="https://maps.app.goo.gl/ERhpKbwzmMoBBZLy9" target="_blank">{dir}</a>
                </div>
            </div>
            ...
            <div className="flex flex-col lg:hidden">
                <div className="flex mx-auto justify-center">
                    ...
                    <p className="mx-1 my-auto font-xs">MP Voices 2022.</p>
                </div>
                <p className="mx-auto font-xs">Todos los derechos reservados.</p>
            </div>
