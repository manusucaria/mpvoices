                ...
                <div className="flex flex-col justify-between h-auto mb-3 pl-6 animate-display bg-[#ffffff]">
                    ...
                    <div className="flex bg-[#ffffff]">
                        <div className="flex mb-2 bg-[#ffffff]">
                            <a onClick={() => setIsNavOpen(false)} href='#EspacioVoices' className="bg-[#ffffff] text-[#0D0D0D] mr-auto font-[550] text-base">Espacio voices</a>
                        </div>
                    </div>
                    ...
                    <div className="flex bg-[#ffffff]">
                        <div className="flex my-2 bg-[#ffffff]">
                            <a onClick={() => setIsNavOpen(false)} href='#MariaPeña' className="bg-[#ffffff] text-[#0D0D0D] mr-auto font-[550] text-base">Maria Peña</a>
                        </div>
                    </div>  
                    ...
                    <div className="flex bg-[#ffffff]">
                        <div className="flex my-2 bg-[#ffffff]">
                            <a onClick={() => setIsNavOpen(false)} href='#Clases' className="bg-[#ffffff] text-[#0D0D0D] mr-auto font-[550] text-base">Clases</a>
                        </div>
                    </div>  
                    ...
                    <div className="flex bg-[#ffffff]">
                        <div className="flex my-2 bg-[#ffffff]">
                            <a onClick={() => setIsNavOpen(false)} href='#NuevosProyectos' className="bg-[#ffffff] text-[#0D0D0D] mr-auto font-[550] text-base">Nuevos proyectos</a>
                        </div>
                    </div>  
                    ...
                    <div className="flex bg-[#ffffff]">
                        <div className="flex my-2 bg-[#ffffff]">
                            <a onClick={() => setIsNavOpen(false)} href='#Footer' className="bg-[#ffffff] text-[#0D0D0D] mr-auto font-[550] text-base">Contacto</a>
                        </div>
                    </div>  
                    ...
                    <div className="flex bg-[#ffffff] pb-4">
                        <div className="flex my-2 bg-[#ffffff]">
                            <Link onClick={() => setIsNavOpen(false)} href='/' className="bg-[#ffffff] text-[#0D0D0D] mr-auto font-[550] text-base">Plataforma alumnos</Link>
                        </div>
                    </div>  
                </div>
            : ""}
