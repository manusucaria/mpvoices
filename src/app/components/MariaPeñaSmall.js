...
const MariaPeñaSmall = () => {
    return (
        <div className='bg-[#ffffff] flex flex-col lg:hidden py-6'>
            ...
            <Image width={500} height={500} className="mx-auto w-16 h-auto mb-6" src={disco} alt='Foto Tapa Disco' />
            <Image width={500} height={500} className="mx-auto w-24 h-auto mb-6" src={usal} alt='Foto Usal' />
            <Image width={500} height={500} className="mx-auto w-24 h-auto mb-6" src={newfield} alt='Foto Newfield' />
            <Image width={500} height={500} className="mx-auto w-14 h-auto mb-6" src={ellipse} alt='Foto Ellipse' />
        </div>
    )
}
