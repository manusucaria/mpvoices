    ...
    <div id='Agenda' className="flex flex-col">
      {selectedDay
        ...
        <div className="flex justify-center mb-4">
          ...
          <div className='my-auto flex ml-4 sm:ml-8'>
            ...
            <p className='text-[#E9500E] my-auto mt-2 lg:mt-1 text-xl sm:text-2xl'>{selectedDay}</p>
          </div>
        </div>
          )
        : (
      ...
      {selectedDay && (
        <div className="flex flex-col overflow-x-auto mx-auto w-full px-2 md:w-4/6 mb-12">
          <div className="grid grid-cols-3 mt-4 h-12 bg-[#FFFFFF] border-r-[0.5px] sm:border-r-[2px] border-r-[#0D0D0D] border-l-[0.5px] sm:border-l-1 border-l-[#0D0D0D] border-t-[0.5px] sm:border-t-1 border-t-[#0D0D0D]">
          ...
          <div className='grid grid-cols-[20%_40%_40%] grid-rows-37 border-y-[0.5px] sm:border-y-1 border-y-[#0D0D0D] border-l-[0.5px] sm:border-l-1 border-l-[#0D0D0D]'>
            ...
            {timeSlots.map((time, index) => (
              <div
                key={index}
                className={`text-center col-start-1 col-end-2 bg-[#FFFFFF] flex h-9 sm:h-12 ${index === timeSlots.length - 1 ? 'border-b-none' : 'border-b-[0.5px] sm:border-b-1 border-b-[#0D0D0D]'}`}
              >
                <p className='text-md sm:text-md md:text-base m-auto text-[#0D0D0D]'>{time}</p>
              </div>
            ))}
            <div className="col-start-2 col-end-4 row-start-1 row-end-38 grid grid-cols-2 bg-[#FFFFFF] border-r-[0.5px] sm:border-r-1 border-r-[#0D0D0D]">
              ...
              <div key={profesor.id} className={`grid grid-cols-1 grid-rows-37 border-l-[0.5px] sm:border-l-1 border-l-[#0D0D0D] text-center ${index === array.length - 1 ? 'border-r-[0.5px] sm:border-r-1 border-r-[#0D0D0D]' : 'border-r-none'}`}>
                <div className='flex row-start-1 row-end-2 h-9 sm:h-12 text-sm bg-[#E9500E] border-b-[0.5px] sm:border-b-1 border-b-[#0D0D0D]'>
