    ...
    <div className='flex flex-col mx-auto w-full'>
      <div className="mx-auto flex justify-center w-full md:w-4/6 lg:w-3/6 mt-4 mb-8">
        <div className="flex my-auto pt-1">
          <svg className='my-auto md:hover:cursor-pointer stroke-[#663481] md:hover:stroke-[#9B70BE]' onClick={handleCancel} width="34" height="32" viewBox="0 0 34 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <form className='flex flex-col mx-auto w-full md:w-4/6 lg:w-3/6 bg-[#0D0D0D] p-8' onSubmit={handleSubmit}>
        <div className='flex border-b-[0.5px] sm:border-b-1 border-b-[#FFFFFF] pb-8 mb-8'>
          ...
          <p className='text-[#9B70BE] my-auto text-xl sm:text-2xl'>crear cuenta</p>
        </div>
        <div className='flex'>
        ...
        <div className='flex w-full mx-auto gap-x-4 mt-8 mb-2'>
          <button
            className='font-botones font-bold h-10 w-3/6 mr-auto rounded-3xl bg-[#663481] text-[#FFFFFF] px-3 md:hover:bg-[#9B70BE]'
            type="submit">
              Crear cuenta
          </button>
          <button
            className='font-botones font-bold h-10 w-3/6 ml-auto rounded-3xl bg-[#FFFFFF] text-[#663481] md:text-[#0D0D0D] md:hover:text-[#663481] border-2 border-[#663481] px-3'
